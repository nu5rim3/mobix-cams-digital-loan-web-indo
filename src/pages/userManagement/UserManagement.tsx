      ...
      render: (_, record) => (
        <>
          <Space size="middle" className='mr-5'>
            <a onClick={() => navigate(`/indo-digital-loan/auth/userManagement/updateUser/${record.idx}`)}>Update {record.name}</a>
          </Space>
    ...
    <div>
      ...
      <ContentContainer >
          ...
          <div>
            <Button 
              onClick={() => {
                navigate('/indo-digital-loan/auth/userManagement/createUser')
              }} 
              type='primary'
              shape="round"
              size={'large'}
